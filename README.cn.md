...
合计: **437,414** 行代码（覆盖前 5 种语言、共 **742** 个文件）。
...
- **Star**: 3,383 · **Fork**: 364 · **开放 issue**: 1,616 · **贡献者**: 175

## 累计统计

- **发布数**: 89 · **已合并 PR**: 402 · **开放 PR**: 37 · **已关闭 issue**: 1214 · **开放 issue**: 402 · **提交数**: 14088
...
在 [repology.org](https://repology.org/project/weechat) 上共有 **268** 个发行版报告此项目。**46** 个 ✅ 已是最新上游版本，**190** 个 ⚠️ 使用旧版本。
...
_数据快照: `data/card/260912.yml` · 2026-09-12T06:01:30Z._
